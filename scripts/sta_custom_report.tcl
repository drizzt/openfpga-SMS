...
set base_dir [pwd]
set project_path "$base_dir/projects/sms_pocket"
...
set out_setup "$report_dir/sms_pocket.sta.paths_setup.rpt"
set out_setup_0c "$report_dir/sms_pocket.sta.paths_setup_current_0c.rpt"
set out_hold  "$report_dir/sms_pocket.sta.paths_hold.rpt"
set out_sum   "$report_dir/sms_pocket.sta.clock_summary.rpt"
...
set out_sdram_wr "$report_dir/sms_pocket.sta.sdram_write.rpt"
report_timing -setup -npaths 10 -detail full_path \
  -to_clock sdram_clk \
  -file $out_sdram_wr

post_message "Generating SDRAM read path report (sdram_clk -> sys_pll)..."
set out_sdram_rd "$report_dir/sms_pocket.sta.sdram_read.rpt"
report_timing -setup -npaths 10 -detail full_path \
