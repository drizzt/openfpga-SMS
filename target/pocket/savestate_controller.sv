...
module savestate_controller (
  ...
  wire bridge_ss_wr = bridge_wr && (bridge_addr[31:28] == 4'h4) && (bridge_addr[27:16] == 12'h0);
  ...
  dpram #(
      ...
      .clock_b  (clk_74a),
      .address_b(bridge_ss_wr ? bridge_addr[15:2] + 14'd1 : bridge_addr[15:2]),
      .wren_b   (bridge_ss_wr),
  ...
  assign buf_data_a = DDRAM_WE ? DDRAM_DIN[31:0] : wr_data_hold;
